...
The available configuration options for running scans are documented in
[Audit config](./audit-config.md).

The outputs generated by running a scan are documented in
[Audit results](./audit-results.md). See below for a full guide on how each
audit works.
